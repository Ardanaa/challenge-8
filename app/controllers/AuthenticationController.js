...
const { EmailNotRegisteredError, InsufficientAccessError, NotFoundError, WrongPasswordError, EmailAlreadyTakenError } = require("../errors");
...
class AuthenticationController extends ApplicationController {
  ...
  handleGetUser = async (req, res) => {
    ...
    if (!role) {
      const err = new NotFoundError(this.roleModel.name);
      res.status(404).json(err)
      return;
    }
